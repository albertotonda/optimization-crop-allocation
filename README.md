...
In order to run an experiment, you will need python (caveat: experiments typically last a few hours each). From the `src/` directory and run `python3 soja_multi_objective.py`